...
import static net.cheney.cocktail.resource.Lock.Scope;
import static net.cheney.cocktail.resource.Lock.Type;
...
public class Lock extends BaseApplication {
	...
	public Response call(Environment env) {
		...
		net.cheney.cocktail.resource.Lock lock = lock(Type.WRITE, Scope.EXCLUSIVE, resource);
